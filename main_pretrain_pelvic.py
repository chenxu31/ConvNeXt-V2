...
def main(args):
    ...
    dataset = common_pelvic.Dataset(args.data_path, args.modality, n_slices=args.n_slices, new_normalize=True)
    ...
    model = fcmae.__dict__[args.model](
        img_size=dataset.patch_height,
        in_chans=args.n_slices,
    ...
    num_training_steps_per_epoch = len(dataset) // eff_batch_size
